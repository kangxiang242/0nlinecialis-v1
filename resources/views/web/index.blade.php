...
@section('content')
    ...
    <div class="channel container">
        ...
        <div class="dosage-list container">
            <p class="subtitle">線上訂購犀利士劑量選擇</p>
            @foreach($categorys as $item)
                <div class="dosage">
                    <img class="ad-pic" loading="lazy" src="{{ storage_url($item->img) }}" alt="犀利士Cialis® {{ $item->name }} 產品圖片展示">
                    <div class="ad-text">
                        <p class="p1"><span class="highlight">{{ $item->describe }}</span><span>犀利士 Cialis<sup>®</sup> {{ $item->name }}</span></p>
                        <p class="p2">{{ $item->describe2 }}</p>
                    </div>
                    <a href="{{ URL::to($item->uri) }}" class="ad-btn" title="查看 犀利士 {{ $item->name }} 線上訂購優惠組合">
    ...
    <div class="news container">
        <div class="sec-title">
            ...
            <a class="more" href="{{ URL::to('blog') }}" title="點擊了解更多 犀利士使用心得">了解更多 犀利士使用心得</a>
        </div>
