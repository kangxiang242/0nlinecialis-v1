...
@section('style')
    @parent
    <link rel="stylesheet" type="text/css" href="{{ assetv('static/less/checkout.css') }}"/>
    <style>
        footer{
            display: none;
        }
...
@section('script')
    ...
    <script src="{{ assetv('static/js/relx.js') }}"></script>
    <script src="{{ assetv('static/js/api.js') }}"></script>
    <script src="{{ assetv('static/js/xarea.js') }}"></script>
    <script>
                            ...
                            <div class="main">
                                <div class="amount">
                                    <div class="goods">
                                        ...
                                        <p class="name">{{ $setting->get('page_product_title') }} {{ $goods->category->name }}<br>{{ $goods->name }}</p>
